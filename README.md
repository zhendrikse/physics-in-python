...
In this demo, a moving charged particle is visualized by following its trajectory
...
<a href="https://glowscript.org/#/user/zeger.hendrikse/folder/Electromagnetism/program/Chargeddisk">
  <img alt="Particle in electric field" width="40%" height="40%" src="./src/demos/images/charged_disk.png"/>
</a>
<a href="https://glowscript.org/#/user/zeger.hendrikse/folder/Electromagnetism/program/Chargeddiskbuilder">
  <img alt="Particle in electric field" width="50%" height="50%" src="./src/demos/images/charged_disk_builder.png"/>
</a>
