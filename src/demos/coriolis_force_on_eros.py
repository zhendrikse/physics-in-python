...
eros = Eros()
ball = Ball(mass=1, position=position_vector, velocity=velocity_vector, radius=EROS_RADIUS / 20,color=color.yellow, make_trail=True)
...
ball_2 = Ball(mass=1, position=position_vector, velocity=velocity_vector, radius=EROS_RADIUS / 20,color=color.magenta, make_trail=True)
