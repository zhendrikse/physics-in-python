#Web VPython 3.2
from vpython import points, vec, pi, box, color, rate, cone, canvas, label, arrow, cylinder, text, checkbox
...
"""
animation = canvas(title=title, forward=vec(-0.25, -0.48, -0.83), range=14)
