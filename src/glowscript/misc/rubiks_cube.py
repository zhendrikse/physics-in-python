...
&#x2022; Based on <a href="https://github.com/mtking2/VPython-Rubiks-Cube/blob/master/PyCube.py">PyCube.py</a> and updated by <a href="https://github.com/zhendrikse/">Zeger Hendrikse</a>
...
cube_scene = canvas(title=title, pos=zero_vec, width=750, height=550, center=zero_vec, background=zero_vec)
