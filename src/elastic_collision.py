...
from vpython import vector, sphere, color, rate, mag, norm
...
def main():
    ...
    for timestep in range(0, 200):
      ...
      force_BA = sphere_A.force_between(sphere_B) if sphere_A.has_collided_with(sphere_B) else vector(0, 0, 0)
