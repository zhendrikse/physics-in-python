...
class plot3D:
    def __init__(self, f, xmin, xmax, xnum, ymin, ymax, ynum, zmin, zmax):
...
p = plot3D(f, 0, 1, 50, 0, 1, 50, 0, 1)  # function, xmin, xmax, ymin, ymax (defaults 0, 1, 0, 1, 0, 1)
