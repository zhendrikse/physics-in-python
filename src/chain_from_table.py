...
# - https://www.youtube.com/watch?v=vXp1hW_t-bo
# - https://trinket.io/glowscript/bbe791bbfe7d
#

from vpython import vector, sphere, color, rate, mag, norm, box
...
def main():
    ...
    table_length = 1
    table_height = 0.1
    table  = box(pos=vector(-table_length/2-.01, -table_height/2-.01,0),size=vector(table_length,table_height,2*table_height), opacity=0.3)
