from vpython import vector, box, sphere, helix, color, mag, norm, gcurve, graph, rate
...
balls = 4    
plot = graph(title=str(balls)+ "-body coupled oscillator",xtitle="Time",ytitle="Amplitude",width=1000, height=250)
...
oscillator.shift_ball(0, vector(0.7, 0, 0))
...
for i in range(0, 10000):
  ...
  for ball_i in range(0, balls):
    curve[ball_i].plot(i * dt, oscillator.ball_position(ball_i).x)
