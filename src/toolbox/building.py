...
class Building:
    def __init__(self, 
        ...
        self._building = self._vpython_box(mass, position, length, height, width, color, up, velocity, omega) if draw else None
    ...
    def _vpython_box(self, mass, position, length, height, width, color, up, velocity, w):
        return box(mass=mass, pos=position, length=length, height=height, width=width, color=color, up=up, velocity=velocity, w=w)
